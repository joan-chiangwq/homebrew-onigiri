cask "onigiri" do
  ...
  url "https://github.com/joan-chiangwq/on-igiri-releases/releases/download/v#{version}/Onigiri-#{version}.dmg"
  name "Onigiri"
  desc "Menu bar app that keeps your Mac awake"
  homepage "https://github.com/joan-chiangwq/on-igiri-releases"
